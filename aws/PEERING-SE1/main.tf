...
resource "aws_internet_gateway_attachment" "PEERING-SE1-VPC1_Attachment" {
  internet_gateway_id = aws_internet_gateway.PEERING-SE1-IG1.id
...
resource "aws_subnet" "PEERING-SE1-subnet-private1" {
  vpc_id            = aws_vpc.PEERING-SE1-VPC1.id
  cidr_block        = "10.2.1.0/24"
  availability_zone = var.az
  tags = {
    Name = "PEERING-SE1-subnet-private1"
  }
  map_public_ip_on_launch = true
}

# Create Routing Table
resource "aws_route_table" "PEERING-SE1-route-public1" {
  vpc_id = aws_vpc.PEERING-SE1-VPC1.id

  route {
    cidr_block = "0.0.0.0/0"
    gateway_id = aws_internet_gateway.PEERING-SE1-IG1.id
  }
  tags = {
    Name = "PEERING-SE1-route-public1"
  }
}

resource "aws_route_table_association" "PEERING-SE1-route-public1-association" {
  subnet_id      = aws_subnet.PEERING-SE1-subnet-private1.id
  route_table_id = aws_route_table.PEERING-SE1-route-public1.id
}
